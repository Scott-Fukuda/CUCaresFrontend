...
import { getServiceJournal, downloadServiceJournalCSV } from "../api";
...
useEffect(() => {
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch service journal
      const response = await fetch(
        `https://cucaresbackend.onrender.com/api/service-journal/opps/${userId}`,
        {
          method: "GET",
          headers: {
    ...
    console.log("Service Journal API data:", JSON.stringify(data, null, 2));
