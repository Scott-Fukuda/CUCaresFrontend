  ...
  return (
    <div className={`sidebar ${toggleSideBar ? 'active' : ''}`}>
      <div className="header">
        ...
        />
        <img src="/logo.png" alt="CampusCares Logo" className="h-11 w-12 object-contain" />
      </div>
      <div className="nav">
        <div
        ...
        <div
          className={`nav-opt ${location.pathname === '/my-opportunities' ? 'active' : ''}`}
          onClick={() => {
            setToggleSideBar(false);
        ...
        <div
          ...
          onClick={() =>
            (window.location.href =
              'mailto:sdf72@cornell.edu?subject=Bug Report - Campus Cares Frontend&body=Please describe the bug you encountered:')
          }
        >
          <p>Report Bug</p>
        </div>
