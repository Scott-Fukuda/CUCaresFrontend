...
import { getProfilePictureUrl, updateOpportunity, getUserById, deleteOpportunity } from '../api';
                ...
                {isUserHost ? (
                 ...
                 {isUserSignedUp && opportunity.host_id && (
                   <div className="bg-white p-6 rounded-2xl shadow-lg">
                     ...
                     {(() => {
                       console.log('Host ID:', opportunity.host_id);
                         ...
                         return (
                           <div className="space-y-3">
                             <div className="flex items-center gap-3">
                               ...
                               <div className="flex-1">
                                 <p className="font-semibold text-gray-800">{hostUser.name}</p>
