...
const AdminPage: React.FC<AdminPageProps> = ({ 
  ...
  // Filter unapproved opportunities and organizations
  const unapprovedOpportunities = useMemo(() => 
    opportunities.filter(opp => opp.approved !== true), 
    [opportunities]
  );
  
  const unapprovedOrganizations = useMemo(() => 
    organizations.filter(org => org.approved !== true), 
    [organizations]
  );
                    ...
                    <tr key={opp.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div>
                          ...
                          <div className="text-sm text-gray-500">{opp.cause}</div>
                        </div>
                      </td>
