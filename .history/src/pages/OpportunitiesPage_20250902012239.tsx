      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredOpportunities.map(opp => {
          ...
          if (opp.involved_users && opp.involved_users.length > 0) {
            ...
            console.log(`Backend involved_users for ${opp.name}:`, opp.involved_users);
            console.log(`Filtered signedUpStudents for ${opp.name}:`, signedUpStudents);
          } else {
            // Fallback to local signups data
            ...
            console.log(`Local signups for ${opp.name}:`, opportunitySignups);
            console.log(`Local signedUpStudents for ${opp.name}:`, signedUpStudents);
          }
