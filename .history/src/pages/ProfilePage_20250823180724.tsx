...
interface ProfilePageProps {
  ...
  refreshFriendshipStatus?: () => Promise<void>; // Optional refresh function
}
...
const ProfilePage: React.FC<ProfilePageProps> = (props) => {
  ...
  // Refresh friendship status - this will be called after friend actions
  const refreshFriendshipStatus = useCallback(async () => {
    if (!isCurrentUser && currentUser) {
      const newStatus = await checkFriendshipStatus(user.id);
