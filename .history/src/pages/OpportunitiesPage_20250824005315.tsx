    ...
    return opportunities
      .filter(opp => {
        ...
        if (dateFilter) {
            ...
            // Show events occurring on the specified date OR the day before (to fix timezone offset)
            if (oppDate.getTime() !== filterDate.getTime() && oppDate.getTime() !== previousDay.getTime()) {
                return false;
            }
        }
