            ...
            {isCurrentUser && !user.bio && (
                <>
                    ...
                    {!isEditing ? (
                        ...
                        <button onClick={() => setIsEditing(false); updateUser(user.id, { "bio": user.bio })} className="bg-cornell-red text-white font-bold py-2 px-4 rounded-lg hover:bg-red-800 transition-colors text-sm">
                            Save Bio
                        </button>
                    )}
                </>
