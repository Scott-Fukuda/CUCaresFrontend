             ...
             {isCurrentUser && !user.bio && (
                ...
                { !isEditing && (
                  <button onClick={() => setIsEditing(true)} className="bg-cornell-red text-white font-bold py-2 px-4 rounded-lg hover:bg-red-800 transition-colors text-sm">
                    ...
                    <button onClick={() => setIsEditing(false) && updateCurrentUser(user.bio)} className="bg-cornell-red text-white font-bold py-2 px-4 rounded-lg hover:bg-red-800 transition-colors text-sm">
                        Save Bio
                    </button>
                  )
                }
