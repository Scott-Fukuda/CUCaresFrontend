    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <button
                ...
                className="flex items-center space-x-2 text-gray-600 hover:text-cornell-red transition-colors group"
              >
            ...
            <div className="text-right">
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Create Opportunity</h1>
              <p className="text-gray-600">Share your passion for community service</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          {/* Form Header */}
          <div className="bg-gradient-to-r from-cornell-red to-red-700 px-8 py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white">New Opportunity Details</h2>
                <p className="text-red-100">Fill out the information below to create your opportunity</p>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Host Organization * (Only registered members of organizations can host opportunities.)
              </label>
              <select
                name="host_org_id"
