                      ...
                      <div className="bg-white p-6 rounded-2xl shadow-lg">
                        ...
                        <button
                          onClick={() => {
                            ...
                            // Get all participant emails - try multiple possible email fields
                            const participantEmails = signedUpStudents
                              .filter(student => {
                                // Check for email in various possible fields using type assertion
                                const studentAny = student as any;
                                const hasEmail = student.email || studentAny.user_email || studentAny.mail;
                                console.log(`Student ${student.firstName} ${student.lastName}:`, { 
                                  email: student.email, 
                                  user_email: studentAny.user_email, 
                                  mail: studentAny.mail,
                                  hasEmail: !!hasEmail 
                                });
                                return hasEmail;
                              })
                              .map(student => {
                                const studentAny = student as any;
                                return student.email || studentAny.user_email || studentAny.mail;
                              })
                              .join(', ');
