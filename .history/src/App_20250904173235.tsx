  ...
  return (
    <div className="min-h-screen bg-light-gray pb-20 md:pb-0">
      ...
      <a
        ...
        className="fixed bottom-20 md:bottom-6 right-4 md:right-6 bg-red-600 hover:bg-red-700 text-white px-3 py-2 md:px-4 md:py-2 rounded-full shadow-lg transition-colors duration-200 flex items-center gap-1 md:gap-2 z-50 text-sm md:text-base"
        title="Report a Bug"
      >
        <svg 
