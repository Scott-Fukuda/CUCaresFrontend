...
import { User, Opportunity, SignUp, FriendRequest, Badge, Organization } from '../types';
...
export const initialStudents: User[] = [
  ...
  { id: 2, firstName: 'Ben', lastName: 'Carter', email: 'bc456@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability', 'Education'], friendIds: [4, 9], organizationIds: [102, 301], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Environmental Engineering', birthday: '2002-08-22', points: 150, registration_date: '2024-01-20T14:15:00' },
  { id: 3, firstName: 'Chloe', lastName: 'Davis', email: 'cd789@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], organizationIds: [401], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Human Ecology', birthday: '2003-12-03', points: 180, registration_date: '2024-02-05T09:45:00' },
  { id: 4, firstName: 'David', lastName: 'Evans', email: 'de101@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability'], friendIds: [2], organizationIds: [102, 501], graduationYear: '2027', academicLevel: 'Undergraduate', major: 'Mechanical Engineering', birthday: '2004-03-18', points: 240, registration_date: '2024-02-12T16:20:00' },
  { id: 5, firstName: 'Emily', lastName: 'Frank', email: 'ef112@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [], organizationIds: [101, 601], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Nutrition Science', birthday: '2003-07-30', points: 120, registration_date: '2024-02-18T11:30:00' },
  { id: 6, firstName: 'Frank', lastName: 'Green', email: 'fg131@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Education'], friendIds: [], organizationIds: [402], graduationYear: '2026', academicLevel: 'Graduate', major: 'Educational Psychology', birthday: '2001-11-14', points: 210, registration_date: '2024-03-01T13:45:00' },
