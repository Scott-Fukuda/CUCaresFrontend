...
export const initialStudents: User[] = [
  ...
  // Admin User
  { id: 9, firstName: 'Ezra', lastName: 'Min', email: 'ejm376@cornell.edu', password: 'test1234', profilePictureUrl: 'https://i.pravatar.cc/150?u=ezra', interests: ['Food Security and Hunger Relief', 'Education', 'Other'], friendIds: [1,2], groupIds: [101, 502], admin: true },
];
