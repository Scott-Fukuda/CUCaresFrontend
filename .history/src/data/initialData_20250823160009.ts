...
import { User, Opportunity, SignUp, FriendRequest, Badge } from '../types';

export const initialStudents: User[] = [
  { id: 1, firstName: 'Alice', lastName: 'Johnson', email: 'aj123@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief', 'Other'], friendIds: [8, 3, 9], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Computer Science', birthday: '2003-05-15', points: 180, registration_date: '2024-01-15T10:30:00' },
  { id: 2, firstName: 'Ben', lastName: 'Carter', email: 'bc456@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability', 'Education'], friendIds: [4, 9], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Environmental Engineering', birthday: '2002-08-22', points: 150, registration_date: '2024-01-20T14:15:00' },
  { id: 3, firstName: 'Chloe', lastName: 'Davis', email: 'cd789@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Human Ecology', birthday: '2003-12-03', points: 180, registration_date: '2024-02-05T09:45:00' },
  { id: 4, firstName: 'David', lastName: 'Evans', email: 'de101@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability'], friendIds: [2], graduationYear: '2027', academicLevel: 'Undergraduate', major: 'Mechanical Engineering', birthday: '2004-03-18', points: 240, registration_date: '2024-02-12T16:20:00' },
  { id: 5, firstName: 'Emily', lastName: 'Frank', email: 'ef112@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Nutrition Science', birthday: '2003-07-30', points: 120, registration_date: '2024-02-18T11:30:00' },
  { id: 6, firstName: 'Frank', lastName: 'Green', email: 'fg131@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Education'], friendIds: [], graduationYear: '2026', academicLevel: 'Graduate', major: 'Educational Psychology', birthday: '2001-11-14', points: 210, registration_date: '2024-03-01T13:45:00' },
  { id: 7, firstName: 'Grace', lastName: 'Hill', email: 'gh141@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Other', 'Environment & Sustainability'], friendIds: [], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Business', birthday: '2003-09-07', points: 240, registration_date: '2024-03-08T15:10:00' },
  { id: 8, firstName: 'Henry', lastName: 'Irving', email: 'hi151@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Agriculture', birthday: '2002-04-25', points: 180, registration_date: '2024-03-15T12:00:00' },
  // Admin User
...
export const initialOpportunities: Opportunity[] = [
  {
    ...
    points: 180, cause: 'Food Security and Hunger Relief', approved: true
  },
  {
    id: 2,
    ...
    points: 150, cause: 'Environment & Sustainability', approved: true
  },
  {
    id: 3,
    ...
    points: 180, cause: 'Education', approved: true
  },
  {
    id: 4,
    ...
    points: 240, cause: 'Other', approved: true
  },
  {
    id: 5,
    ...
    points: 120, cause: 'Other', approved: true
  },
  {
    id: 6,
    ...
    points: 210, cause: 'Education', approved: true
  },
  {
    id: 7,
  ...
  },
  {
    ...
    points: 240, cause: 'Environment & Sustainability', approved: true
  },
];
