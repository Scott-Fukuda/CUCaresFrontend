...
export const initialStudents: User[] = [
  { id: 1, name: 'Alice Johnson', email: 'aj123@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief', 'Other'], friendIds: [8, 3, 9], organizationIds: [101, 201], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Computer Science', birthday: '2003-05-15', points: 180, registration_date: '2024-01-15T10:30:00' },
      { id: 2, name: 'Ben Carter', email: 'bc456@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability', 'Education'], friendIds: [4, 9], organizationIds: [102, 301], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Environmental Engineering', birthday: '2002-08-22', points: 150, registration_date: '2024-01-20T14:15:00' },
    { id: 3, name: 'Chloe Davis', email: 'cd789@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], organizationIds: [401], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Human Ecology', birthday: '2003-12-03', points: 180, registration_date: '2024-02-05T09:45:00' },
