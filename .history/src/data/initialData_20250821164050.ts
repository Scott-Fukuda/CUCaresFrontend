...
export const initialStudents: User[] = [
  { id: 1, firstName: 'Alice', lastName: 'Johnson', email: 'aj123@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief', 'Other'], friendIds: [8, 3, 9], groupIds: [101, 201], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Computer Science', birthday: '2003-05-15', points: 180 },
  { id: 2, firstName: 'Ben', lastName: 'Carter', email: 'bc456@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability', 'Education'], friendIds: [4, 9], groupIds: [102, 301], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Environmental Engineering', birthday: '2002-08-22', points: 150 },
  { id: 3, firstName: 'Chloe', lastName: 'Davis', email: 'cd789@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], groupIds: [401], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Human Ecology', birthday: '2003-12-03', points: 180 },
  { id: 4, firstName: 'David', lastName: 'Evans', email: 'de101@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability'], friendIds: [2], groupIds: [102, 501], graduationYear: '2027', academicLevel: 'Undergraduate', major: 'Mechanical Engineering', birthday: '2004-03-18', points: 240 },
  { id: 5, firstName: 'Emily', lastName: 'Frank', email: 'ef112@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [], groupIds: [101, 601], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Nutrition Science', birthday: '2003-07-30', points: 120 },
  { id: 6, firstName: 'Frank', lastName: 'Green', email: 'fg131@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Education'], friendIds: [], groupIds: [402], graduationYear: '2026', academicLevel: 'Graduate', major: 'Educational Psychology', birthday: '2001-11-14', points: 210 },
  { id: 7, firstName: 'Grace', lastName: 'Hill', email: 'gh141@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Other', 'Environment & Sustainability'], friendIds: [], groupIds: [102], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Business', birthday: '2003-09-07', points: 240 },
  { id: 8, firstName: 'Henry', lastName: 'Irving', email: 'hi151@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], groupIds: [202], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Agriculture', birthday: '2002-04-25', points: 180 },
  // Admin User
