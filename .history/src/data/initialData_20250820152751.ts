...
export const initialStudents: User[] = [
  { id: 1, firstName: 'Alice', lastName: 'Johnson', email: 'aj123@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=alice', interests: ['Food Security and Hunger Relief', 'Other'], friendIds: [8, 3, 9], groupIds: [101, 201], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Computer Science', birthday: '2003-05-15' },
  { id: 2, firstName: 'Ben', lastName: 'Carter', email: 'bc456@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=ben', interests: ['Environment & Sustainability', 'Education'], friendIds: [4, 9], groupIds: [102, 301], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Environmental Engineering', birthday: '2002-08-22' },
  { id: 3, firstName: 'Chloe', lastName: 'Davis', email: 'cd789@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=chloe', interests: ['Food Security and Hunger Relief'], friendIds: [1], groupIds: [401], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Human Ecology', birthday: '2003-12-03' },
  { id: 4, firstName: 'David', lastName: 'Evans', email: 'de101@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=david', interests: ['Environment & Sustainability'], friendIds: [2], groupIds: [102, 501], graduationYear: '2027', academicLevel: 'Undergraduate', major: 'Mechanical Engineering', birthday: '2004-03-18' },
  { id: 5, firstName: 'Emily', lastName: 'Frank', email: 'ef112@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=emily', interests: ['Food Security and Hunger Relief'], friendIds: [], groupIds: [101, 601], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Nutrition Science', birthday: '2003-07-30' },
  { id: 6, firstName: 'Frank', lastName: 'Green', email: 'fg131@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=frank', interests: ['Education'], friendIds: [], groupIds: [402], graduationYear: '2026', academicLevel: 'Graduate', major: 'Educational Psychology', birthday: '2001-11-14' },
  { id: 7, firstName: 'Grace', lastName: 'Hill', email: 'gh141@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=grace', interests: ['Other', 'Environment & Sustainability'], friendIds: [], groupIds: [102], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Business', birthday: '2003-09-07' },
  { id: 8, firstName: 'Henry', lastName: 'Irving', email: 'hi151@cornell.edu', password: 'password123', profilePictureUrl: 'https://i.pravatar.cc/150?u=henry', interests: ['Food Security and Hunger Relief'], friendIds: [1], groupIds: [202], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Agriculture', birthday: '2002-04-25' },
  // Admin User
  { id: 9, firstName: 'Ezra', lastName: 'Min', email: 'ejm376@cornell.edu', password: 'test1234', profilePictureUrl: 'https://i.pravatar.cc/150?u=ezra', interests: ['Food Security and Hunger Relief', 'Education', 'Other'], friendIds: [1,2], groupIds: [101, 502], admin: true, graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Information Science', birthday: '2002-01-12' },
];
