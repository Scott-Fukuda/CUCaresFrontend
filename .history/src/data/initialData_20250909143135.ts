...
export const initialBadges: Badge[] = [
    { id: 'first-volunteer', name: 'First Step', description: 'Signed up for your first opportunity!', icon: 'dist/badges/first-volunteer.png', threshold: (d) => d.signUpCount >= 1 },
    { id: 'point-novice', name: 'Point Novice', description: 'Earned over 20 points.', icon: 'dist/badges/point-novice.png', threshold: (d) => d.points > 20 },
    { id: 'point-adept', name: 'Point Adept', description: 'Earned over 50 points.', icon: 'dist/badges/point-adept.png', threshold: (d) => d.points > 50 },
    { id: 'point-master', name: 'Point Master', description: 'Earned over 100 points.', icon: 'dist/badges/point-master.png', threshold: (d) => d.points > 100 },
    { id: 'serial-volunteer', name: 'Serial Volunteer', description: 'Signed up for 3+ opportunities.', icon: 'dist/badges/serial-volunteer.png', threshold: (d) => d.signUpCount >= 3 },
    { id: 'community-pillar', name: 'Community Pillar', description: 'Signed up for 5+ opportunities.', icon: 'dist/badges/community-pillar.png', threshold: (d) => d.signUpCount >= 5 },
    { id: 'social-butterfly', name: 'Social Butterfly', description: 'Made 3+ friends.', icon: 'dist/badges/social-butterfly.png', threshold: (d) => d.friendsCount >= 3 },
    { id: 'networker', name: 'Super Networker', description: 'Made 5+ friends.', icon: 'dist/badges/networker.png', threshold: (d) => d.friendsCount >= 5 },
    { id: 'eco-warrior', name: 'Eco Warrior', description: 'Volunteered for 2+ environmental events.', icon: 'dist/badges/eco-warrior.png', threshold: (d) => countSignupsForCause('Environment & Sustainability', d) >= 2 },
    { id: 'community-champion', name: 'Hunger Hero', description: 'Volunteered for 2+ food security events.', icon: 'dist/badges/community-champion.png', threshold: (d) => countSignupsForCause('Food Security and Hunger Relief', d) >= 2 },
    { id: 'top-ten', name: 'Top Ten', description: 'Ranked top ten on leaderboard.', icon: 'dist/badges/top-ten.png', threshold: (d) => findRank(d) <= 10 },
  ];