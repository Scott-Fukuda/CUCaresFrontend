...
export const initialStudents: User[] = [
  { id: 1, name: 'Alice Johnson', email: 'aj123@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief', 'Other'], friendIds: [8, 3, 9], organizationIds: [101, 201], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Computer Science', birthday: '2003-05-15', points: 180, registration_date: '2024-01-15T10:30:00' },
    ...
    { id: 4, name: 'David Evans', email: 'de101@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Environment & Sustainability'], friendIds: [2], organizationIds: [102, 501], graduationYear: '2027', academicLevel: 'Undergraduate', major: 'Mechanical Engineering', birthday: '2004-03-18', points: 240, registration_date: '2024-02-12T16:20:00' },
      { id: 5, name: 'Emily Frank', email: 'ef112@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [], organizationIds: [101, 601], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Nutrition Science', birthday: '2003-07-30', points: 120, registration_date: '2024-02-18T11:30:00' },
    { id: 6, name: 'Frank Green', email: 'fg131@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Education'], friendIds: [], organizationIds: [402], graduationYear: '2026', academicLevel: 'Graduate', major: 'Educational Psychology', birthday: '2001-11-14', points: 210, registration_date: '2024-03-01T13:45:00' },
    { id: 7, name: 'Grace Hill', email: 'gh141@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Other', 'Environment & Sustainability'], friendIds: [], organizationIds: [102], graduationYear: '2025', academicLevel: 'Undergraduate', major: 'Business', birthday: '2003-09-07', points: 240, registration_date: '2024-03-08T15:10:00' },
    { id: 8, name: 'Henry Irving', email: 'hi151@cornell.edu', password: 'password123', profilePictureUrl: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], organizationIds: [202], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Agriculture', birthday: '2002-04-25', points: 180, registration_date: '2024-03-15T12:00:00' },
    // Admin User
