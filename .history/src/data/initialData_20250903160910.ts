...
export const initialStudents: User[] = [
  ...
  { id: 8, name: 'Henry Irving', email: 'gh141@cornell.edu', password: 'password123', profile_image: undefined, interests: ['Food Security and Hunger Relief'], friendIds: [1], organizationIds: [202], graduationYear: '2026', academicLevel: 'Undergraduate', major: 'Agriculture', birthday: '2002-04-25', points: 180, car_seats: 0, registration_date: '2024-03-15T12:00:00' },
  // Admin User
