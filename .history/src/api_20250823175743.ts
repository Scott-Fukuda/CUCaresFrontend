...
export const checkFriendshipStatus = (userId: number, friendId: number): Promise<FriendshipStatus> => 
  request(`/users/${userId}/friends/check/${friendId}`);
...
export const createOpportunity = async (formData: FormData): Promise<Opportunity> => {
  // Add approved: false to the form data for new opportunities
