  ...
  const renderPage = () => {
    ...
    switch (pageState.page) {
        ...
        case 'opportunityDetail':
            ...
            return <OpportunityDetailPage opportunity={opp} students={students} signups={signups} currentUser={currentUser} handleSignUp={handleSignUp} handleUnSignUp={handleUnSignUp} setPageState={setPageState} allOrgs={studentGroups} currentUserSignupsSet={currentUserSignupsSet} />;
        case 'leaderboard':
