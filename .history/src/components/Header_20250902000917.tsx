...
import { User, Organization, ApiFriendRequest } from '../types';
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
        ...
        <div className="flex-1 flex justify-center md:justify-end items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <img src={getProfilePictureUrl(user.profile_image)} alt={user.name} className="h-10 w-10 rounded-full object-fill cursor-pointer" onClick={() => setPageState({ page: 'profile' })} />
