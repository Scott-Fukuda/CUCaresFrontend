      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
        ...
        <div className="flex-1 flex justify-center md:justify-end items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <img src={getProfilePictureUrl(user.profilePictureUrl)} alt={`${user.firstName} ${user.lastName}`} className="h-10 w-10 rounded-full object-cover object-center cursor-pointer" onClick={() => setPageState({ page: 'profile' })} />
