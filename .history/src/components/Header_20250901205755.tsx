...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  return (
    <header className="bg-white shadow-md w-full mb-8 sticky top-0 z-20">
      {/* Header Image */}
      <div className="w-full h-32 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/header.jpeg)' }}>
        <div className="w-full h-full bg-black bg-opacity-30 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-white text-center">CampusCares</h1>
        </div>
      </div>
