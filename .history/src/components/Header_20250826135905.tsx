...
import { User, Organization, FriendRequest } from '../types';
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
        ...
        <div className="flex-1 flex justify-center md:justify-end items-center gap-4">
            ...
            <div className="relative w-full max-w-sm hidden md:block">
                <SearchBar key={`searchbar-${user.id}-${user.profilePictureUrl || 'no-image'}`} {...props} currentUser={props.user} />
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <img src={getProfilePictureUrl(user.profilePictureUrl)} alt={`${user.firstName} ${user.lastName}`} className="h-10 w-10 rounded-full object-cover cursor-pointer" onClick={() => setPageState({ page: 'profile' })} />
