...
const App: React.FC = () => {
  ...
  const updateProfilePicture = useCallback(async (file: File) => {
    ...
    try {
      ...
      console.log('Updating profile picture - before:', currentUser.profilePictureUrl);
      ...
      showPopup('Profile Picture Updated!', 'Your profile picture has been successfully updated and is now visible across the app.', 'success');
    } catch (error: any) {
