...
export const getOpportunities = async (): Promise<Opportunity[]> => {
    try {
        ...
        const transformedOpportunities = (response.opportunities || []).map((opp: any) => {
            ...
            // Use the image_url directly from backend (e.g., "https://imgur.com/a/y0f0Geb")
            ...
            return {
                ...
                address: opp.address // Include address from backend
            };
        });
...
// --- Create Opportunity ---
export const createOpportunity = async (data: any): Promise<Opportunity> => {
