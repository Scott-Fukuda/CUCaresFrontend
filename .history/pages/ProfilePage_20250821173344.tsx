...
interface ProfilePageProps {
  ...
  userFriends: User[]; // Friends of the user being viewed
...
const ProfilePage: React.FC<ProfilePageProps> = (props) => {
  const { 
    ...
    updateProfilePicture, handleFriendRequest, handleRemoveFriend, friendRequests, checkFriendshipStatus
  } = props;
  ...
  }, [isCurrentUser, currentUser, user.id, checkFriendshipStatus]);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-1 space-y-8">
        <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
            ...
            <div className="mt-4 text-gray-600 font-semibold flex justify-center items-center gap-3">
              <span>{userFriends.length} Friends</span>
                ...
                {isFriend ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        onClick={() => handleRemoveFriend(user.id)} 
                        className="flex-1 bg-red-600 text-white font-bold py-2 px-4 rounded-lg hover:bg-red-700 transition-colors text-sm"
                      >
                        Decline
                      </button>
                    </div>
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg">
            <h3 className="text-xl font-bold mb-4">{user.firstName}'s Friends ({userFriends.length})</h3>
