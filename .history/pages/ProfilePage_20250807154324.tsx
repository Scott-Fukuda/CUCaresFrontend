...
import { User, Badge, Organization, allInterests, FriendRequest } from '../types';
...
const ProfilePage: React.FC<ProfilePageProps> = (props) => {
  const { 
    ...
    updateProfilePicture, handleFriendRequest, handleRemoveFriend, friendRequests
  } = props;
  ...
  const handleInterestChange = (interest: string) => {
    ...
    if (!isCurrentUser) {
      console.log('Not current user, returning early');
      return;
    }
