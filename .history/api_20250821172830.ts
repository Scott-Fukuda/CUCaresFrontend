...
export const getUserFriendRequests = (userId: number): Promise<FriendRequest[]> => request(`/users/${userId}/friend-requests`);

export const getUserFriendships = (userId: number): Promise<Friendship[]> => request(`/users/${userId}/friendships`);
