...
const Login: React.FC<LoginProps> = ({ onGoogleSignIn, onShowRegister, error, isLoading }) => {
  return (
    <div className="w-full max-w-md mx-auto bg-white p-8 rounded-2xl shadow-lg text-center mt-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full bg-cornell-red text-white font-semibold py-3 px-4 rounded-lg hover:bg-red-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
        >
          {isLoading ? (
            <>
