...
const Register: React.FC<RegisterProps> = ({ onRegister, onBackToLogin, error, isLoading }) => {
  ...
  const handleRegisterSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (firstName.trim() && lastName.trim() && phone.trim() && graduationYear.trim() && academicLevel.trim()) {
      onRegister(firstName.trim(), lastName.trim(), phone.trim(), gender, graduationYear.trim(), academicLevel.trim());
    }
  };
